...
function LikeAction({
  ...
  const [heartBeatAnimation, setHeartBeatAnimation] = useState(null);
  const [likesLengthPositiveAnimation, setLikesLengthPositiveAnimation] =
    useState(null);
  const handlePostLike = (postId, findedPost) => {
    console.log("Post id =>", postId);
    setHeartBeatAnimation(true);
    setLikesLengthPositiveAnimation(true);
